...
%Tire 4=Michelin 13"
weight_on_tire = weight_on_tire*0.224809;
weight_on_tire(weight_on_tire>375) = 375;
coefficient_of_friction_correction = 0.55;

if tire_choice==1
    friction_instant = coefficient_of_friction_correction * ...
        (7.2542E-11*weight_on_tire.^4 - 6.1031E-08*weight_on_tire.^3 + ...
        1.5083E-05*weight_on_tire.^2 - 1.8194E-03*weight_on_tire + ...
        2.5472E+00);
elseif tire_choice==2
    friction_instant = coefficient_of_friction_correction * ...     
        (9.1129E-11*weight_on_tire.^4 - 7.0271E-08*weight_on_tire.^3 + ...
        1.6161E-05*weight_on_tire.^2 - 1.7813E-03*weight_on_tire + ...
        2.6989E+00);
elseif tire_choice==3
    friction_instant = coefficient_of_friction_correction * ...
        (1.0498E-10*weight_on_tire.^4 - 1.0451E-07*weight_on_tire.^3 + ...
        3.4614E-05*weight_on_tire.^2 - 4.5785E-03*weight_on_tire + ...
        2.7045E+00);
elseif tire_choice==4
    friction_instant = coefficient_of_friction_correction * ...
        (-5.0728E-11*weight_on_tire.^4 + 4.5286E-08*weight_on_tire.^3 - ...
        1.4487E-05*weight_on_tire.^2 - 9.8030E-05*weight_on_tire + ...
        2.1029E+00);
elseif tire_choice==5
    friction_instant = 1.50;
end
friction_instant = friction_instant;
end